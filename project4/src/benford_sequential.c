 ...
 * Stephanie Taylor
 * This is Stephanie Taylor's code to count the occurrences of each number being a leading digit.
 * It is meant so determine whether or not a set of data follows Benford's law and begins by reading in binary data file.
 */
...
There are 495 8's
There are 477 9's
It took 0.000142 seconds for the whole thing to run
*/
...
There are 51298 8's
There are 46745 9's
It took 0.014354 seconds for the whole thing to run
